...
public class Delete extends JFrame {
	...
	//	S_Pricel.setFont(new Font("Bradley Hand ITC ", 1, 20));
		...
		add(P_Price);
		P_Pricel.setBounds(900, 60, 100, 20);	
...
//		add(discountl);
		...
		//minl.setFont(new Font("Bradley Hand ITC ", 1, 20));
		JButton su= new JButton("Delete");

		add(Aboutl);
		su.setBounds(550, 500, 100, 20);
				add(su);
			...
			su.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					int dialogResult = JOptionPane.showConfirmDialog(null, "sure you want to delete", "Title on Box", dialogButton);					// TODO Auto-generated method stub
				...
				{if(dialogResult==0)
					{
						...
						con = DriverManager.getConnection(Constant.CONNECTION_STRING,Constant.USRENAME,Constant.PASSWORD);
						st=con.createStatement();
						String querry = "delete from PRODUCT where id='"+idl.getText()+"'";
						st.executeUpdate(querry);
						JOptionPane.showInputDialog(null, "Suucesfull deleted");
