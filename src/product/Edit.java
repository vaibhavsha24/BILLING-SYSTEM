				...
				sub.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						try
						{
							...
							con = DriverManager.getConnection(Constant.CONNECTION_STRING,Constant.USRENAME,Constant.PASSWORD);
							st=con.createStatement();
							String querry = "UPDATE product SET name='"+namel.getText()+"',mby='"+M_byl.getText()+"',mdate='"+M_Date.getText()+"', edate='"+e_datel.getText()+"',salep='"+S_Pricel.getText()+"', pprice=' "+P_Pricel.getText()+"' ,stock=' "+quantityl.getText()+"' ,status=' "+statusl.getText()+"', mstock=' "+minl.getText()+"',about='+"+Aboutl.getText()+"'WHERE ID='"+na.getText()+"'";
							//String querry = "UPDATE product SET name='"+namel.getText()+"'WHERE ID='"+na.getText()+"'";
